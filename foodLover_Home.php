...
<div class="container-fluid">
  <div class="row">
      ...
      <div class="col-md-4 col-sm-2 col-xs-12">
          <!-- <iframe src="qrcode.php" frameBorder="0"></iframe> -->
          <iframe frameborder="0" style="height: 185px; overflow:scroll; width: 100%" src="qrcode.php" marginheight="1" marginwidth="1" name="cboxmain" id="cboxmain" seamless="seamless" scrolling="no" frameborder="0" allowtransparency="true"></iframe>
